...
public class EZMQXXmlSubscriberTest {
    ...
    private final String FILE_PATH = "src/test/resources/sample_data_model.aml";
    ...
    public void getSubscriberTest2() throws EZMQXException {
        ...
        EZMQXXmlSubscriber subscriber = EZMQXXmlSubscriber.getSubscriber(TOPIC, true, mCallback);
        assertNotNull(subscriber);
        subscriber.terminate();
    }
